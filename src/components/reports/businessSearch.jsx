...
const _BusinessSearchReport = ({ report }) => {
  const business = report.business;
  return (
    <Page>
      <ReportHeader />
      <div className="inner-page">
        <InnerReportHeader report={report} term={"BUSINESS"} />
...
export const BusinessSearchReport = connect(function (state) {
  return {
    report: state.global.report,
  };
})(_BusinessSearchReport);
export default BusinessSearchReport;
