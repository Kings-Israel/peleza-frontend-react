...
api.defaults.baseURL = process.env.NODE_ENV === 'development' ? `http://${window.location.hostname}:8000/peleza-backend-server/api/` : 'http://209.38.220.196/peleza-backend-server/api' 
