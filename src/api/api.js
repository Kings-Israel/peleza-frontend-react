...
api.defaults.baseURL = process.env.NODE_ENV === 'development' ? `http://${window.location.hostname}:8000/peleza-backend/api/` : 'http://172.105.95.169/peleza-backend-test/api/'
